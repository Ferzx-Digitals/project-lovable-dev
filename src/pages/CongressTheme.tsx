      ...
      <section className="py-16 px-4 bg-forest-mist/20">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="space-y-6">
            {streams.map((s, i) => (
              <div key={i} className={`flex flex-col ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-6 items-center bg-card rounded-2xl overflow-hidden shadow-md border border-border`}>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {objectives.map((obj, i) => (
              <div key={i} className="relative group bg-card rounded-2xl overflow-hidden shadow-md border border-border">
