        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="relative mb-8">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-border bg-card text-foreground focus:ring-2 focus:ring-forest-primary/30 focus:border-forest-primary outline-none transition-all shadow-sm"
            />
          </div>
            ...
            {categories.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  activeCategory === cat
                    ? 'bg-forest-primary text-primary-foreground shadow-forest'
                    : 'bg-card text-muted-foreground hover:bg-forest-primary/10 border border-border'
                )}
              >
                {categoryLabels[cat]}
              </button>
          ...
          <div className="mt-16 text-center bg-card rounded-2xl p-10 shadow-md border border-border">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={`/${language}/contact`} className="px-6 py-3 bg-forest-primary text-primary-foreground rounded-full font-semibold hover:bg-forest-deep transition-colors shadow-forest">
                {t('faq.contactUs')}
              </Link>
