...
const Press = () => {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {['English', 'Español', 'Français'].map((lang) => (
              <div key={lang} className="bg-card rounded-xl p-5 border border-border text-center">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-4">
            {pressReleases.map((pr, i) => (
              <div key={i} className="bg-card rounded-xl p-6 border border-border flex flex-col md:flex-row gap-4 items-start">
      ...
      <section className="py-16 px-4 bg-forest-mist/20">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mt-8">
            <a href={PHOTO_GALLERY_DRIVE} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-forest-primary text-primary-foreground rounded-full font-semibold hover:bg-forest-deep transition-colors">
              {t('press.downloadAll')}
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 forest-gradient text-center">
