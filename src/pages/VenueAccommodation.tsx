    ...
    <div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className="bg-card rounded-xl p-6 border border-border shadow-sm text-center hover:shadow-md transition-all hover:-translate-y-1">
      ...
      <section className="py-16 px-4 section-leaf-pattern">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {hotels.map((hotel) => (
              <div key={hotel.name} className="bg-card rounded-2xl overflow-hidden shadow-md border border-border hover:shadow-xl transition-all hover:-translate-y-1">
                {hotel.official && (
          ...
          <div className="mt-8 bg-card rounded-xl p-6 border border-border text-center shadow-sm">
      ...
      <section className="py-16 px-4 section-leaf-pattern">
        ...
        <div className="text-center mt-8">
          <a href={REGISTRATION_URL} target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-forest-primary text-primary-foreground font-bold rounded-full hover:bg-forest-deep transition-colors shadow-forest">
